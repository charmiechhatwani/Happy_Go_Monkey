...
var score;
var ground, gameover, restart, gameoverImage, restartImage;
var gamestate = "play";
var END;
var survivalTime = 0;
var bgdimage, jungleimage;
var bananaScore = 0
...
function setup() {
 ...
 bgdimage = createSprite(200, 200, 10, 10);
...
function draw() {
  ...
  bgdimage.addImage("image", jungle)
  drawSprites();
